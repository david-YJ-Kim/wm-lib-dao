package com.abs.wm.lib.dao.domain.wip.model;

import com.abs.wm.lib.dao.util.code.UseStatCd;
import com.abs.wm.lib.dao.util.code.UseYn;
import com.abs.wm.lib.dao.util.code.WorkStatCd;
...
public class WnWipStat {
    ...
    @Id
    @GenericGenerator(name = "WN_WIP_STAT_SEQ_GENERATOR", strategy = "com.abs.wm.lib.dao.util.ObjIdGenerator")
