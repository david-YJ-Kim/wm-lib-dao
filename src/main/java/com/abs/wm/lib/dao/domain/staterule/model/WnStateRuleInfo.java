package com.abs.wm.lib.dao.domain.staterule.model;
...
public class WnStateRuleInfo {
    ...
    @Id
    @GenericGenerator(name = "WN_STATE_RULE_INFO_SEQ_GENERATOR", strategy = "com.abs.wm.lib.dao.util.ObjIdGenerator")
